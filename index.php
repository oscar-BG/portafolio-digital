        ...
        <article>
            <section>
                ...
                <p>
                    ...
                    de Software actualmente curso el septimo semestre.
                </p>
                <p>
                ...
                <div class="contenedor_con">
                    ...
                    <div class="conocimientos">
                        ...
                        <strong>PHP</strong><progress min="0" max="100" value="30"></progress>
                    </div>
                    <div class="conocimientos">
                        <img src="https://img.icons8.com/color/48/000000/html-5--v1.png"/>
                        <strong>HTML5</strong><progress min="0" max="100" value="30"></progress>
                    </div>
                    <div class="conocimientos">
                        <img src="https://img.icons8.com/color/48/000000/css3.png"/>
                        <strong>CSS3</strong><progress min="0" max="100" value="30"></progress>
                    </div>
                </div>
                </br>
            ...
            <section>
                ...
                <div class="contenedor_img">
                    ...
                    <div class="galeria">
                       <img src="https://dl.dropboxusercontent.com/s/fbdezszr6k5mzcg/HTML5.jpg?dl=0" alt="">
                    </div>
                </div>
            </section>
        </article> 
        ...
        <footer>
            <nav class="nav__contacto">
                ...
                <a href="https://github.com/oscar-BG" target="_blank">
                    <picture>
                        <source media="(min-width: 1000px)" srcset="modulos/icon/github-150.png">
                        <source media="(min-width: 200px)" srcset="modulos/icon/github-250.png">
                        <img src="modulos/icon/github-250.png" alt="cuenta">
                    </picture>
                </a>
                <a href="https://www.facebook.com/Ingenieros-en-Software-102111935247104" target="_blank">
                    <picture>
                        <source media="(min-width: 1000px)" srcset="modulos/icon/facebook-150.png">
                        <source media="(min-width: 200px)" srcset="modulos/icon/facebook-250.png">
                        <img src="modulos/icon/github-250.png" alt="cuenta">
                    </picture>
                </a>
            </nav>
